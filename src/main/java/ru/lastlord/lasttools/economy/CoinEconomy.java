...
public class CoinEconomy {
    ...
    public static final ConcurrentHashMap<String, Integer> coinCache = new ConcurrentHashMap<>();
    ...
    public static void setBalance(String playerName, double amount) {
        ...
        LastTools.database.executeUpdate("UPDATE users SET coins = " + amount + " WHERE player = '" + playerName + "';");
        coinCache.put(playerName, (int) amount);
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                if (resultSet != null && resultSet.next()) {
                    coinCache.put(playerName, Integer.valueOf(resultSet.getString("coins")));
                    cacheTimestamps.put(playerName, System.currentTimeMillis());
